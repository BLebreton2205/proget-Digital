  ...
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
    <div class="card" style="margin:2%">
      ...
      <div class="card-body">
        ...
        <p class="card-text"><span><i class="bi bi-hospital" style="font-size: 1.5rem; color: black;"></i></span> ${cur.etablissement}</p
        <p class="card-text"><span><i class="bi bi-calendar-date" style="font-size: 1.5rem; ccolor: black;"></i></span> ${cur.periode}</p>
      </div>
