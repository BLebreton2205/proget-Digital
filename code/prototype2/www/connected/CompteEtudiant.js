  ...
  let body = $('body').append(`
      <div class="container-fluid">
          ...
          <div class="row header">
              <article style='padding:0%' class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
              ...
              <article class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                  <!--    Ajoute du bouton de Proposition   -->
                  <div class = 'd-flex align-items-center justify-content-center h-100' style="text-align: center;">
                    <button id="prop" type="button" class = 'btn btn-primary-outline justify-content-center h-100'>
                      <h2>Proposition</h2>
                    </button>
                  </div>
              </article>
              <article class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                  <!--    Ajouter du user   -->
                  <svg class="position-absolute" style="right: 0.5%; top: 0.5%" width="75" height="75" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <circle cx="37.5" cy="37.5" r="37.5" fill="#6EAC5F"/>
                      <g clip-path="url(#clip0_118:2506)">
                      <path d="M37.0594 37.7611C29.1169 37.7611 22.7188 31.3629 22.7188 23.4204C22.7188 15.4779 29.1169 9.07971 37.0594 9.07971C45.0019 9.07971 51.4001 15.4779 51.4001 23.4204C51.4001 31.3629 45.0019 37.7611 37.0594 37.7611ZM37.0594 13.4922C31.5438 13.4922 27.1313 17.9047 27.1313 23.4204C27.1313 28.936 31.5438 33.3485 37.0594 33.3485C42.5751 33.3485 46.9876 28.936 46.9876 23.4204C46.9876 17.9047 42.5751 13.4922 37.0594 13.4922Z" fill="black"/>
                      <path d="M17.6438 55.191V64.7141C17.6438 65.8074 13.2317 65.8074 13.2317 64.7141V55.191C13.2317 46.4761 23.9318 39.7476 37.5005 39.7476C51.0692 39.7476 61.7693 46.4761 61.7693 55.191V64.7141C61.7693 65.8074 57.3573 65.8074 57.3573 64.7141V55.191C57.3573 49.2342 48.3111 44.1596 37.5005 44.1596C26.69 44.1596 17.6438 49.2342 17.6438 55.191Z" fill="black"/>
                      </g>
                      <defs>
                      <clipPath id="clip0_118:2506">
